...
import { ContractFile } from '../contract-info/callee_contract';
	...
	*/
   	async "new" (
		...
		const storageDepositLimit = __options?.storageDepositLimit;
			const tx = code.tx["new"]!({ gasLimit, storageDepositLimit, value: __options?.value }, secretString, secretStruct);
			let response;
